    ...
    <div className="w-full bg-black">
      <div className="w-[90%] bottom-10 mx-auto block md:flex justify-between">
        <div className="md:w-[35%] w-full">
          <div className="py-8 bg-yellowColor md:bg-white flex items-center pl-[8%] md:pl-[10%] gap-[3rem]">
        ...
        <div className="md:w-[65%] w-full">
          <div className="py-8 bg-yellowColor flex items-center pl-[8%] gap-[3rem]">
